        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4">
              <div className="rounded-3xl bg-white bg-opacity-95 px-4 py-3 text-sm font-semibold uppercase tracking-wide transition ease-out group-hover:bg-purple-600 group-hover:text-white dark:border-gray-800 dark:bg-gray-900/90">
                Electronics
              </div>
            </div>
          </a>
